...
export function EscalationsDashboard({ embedded = false }: { embedded?: boolean }) {
  ...
  return (
    <main className={embedded ? '' : 'min-h-svh bg-[#f2fbf6] text-[#17382b]'}>
      {!embedded ? (
      ...
      <section className={embedded ? '' : 'mx-auto w-full max-w-7xl px-5 pb-12 sm:px-8 lg:px-10'}>
